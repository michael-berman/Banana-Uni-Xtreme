...
class Game {
  ...
  moveBike(e){
    ...
    switch(e.keyCode){
      ...
      case 38:
        break;
      case 32:
        // TODO: restart game if gameover is true
        break;
      default:
        impulse = [0, 0];
        break;
  ...
  renderGameOver(){
    ...
    gameOverModal.innerHTML = "Game over! Press space bar to restart"
  }
  ...
  checkMonkeyCollision(){
    ...
    if (monkeyPos[0] < unicyclePos[0] + 105
        && monkeyPos[0] + 105 > unicyclePos[0]
        && monkeyPos[1] - 130 < unicyclePos[1]
            ){
      return true;
    } else {
      return false;
...
class Level1Obstacle{
  constructor(){
    ...
    this.spritePos = [200, 230]; // 110000 normal position
    this.spriteFrame = 0;
  }
