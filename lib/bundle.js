...
const SkyMonkeyPos = __webpack_require__(6);
...
class Level1Obstacle{
  constructor(){
    ...
    this.skyMonkeyPosX = 300; // TODO: make an array and iterate over
  }
  ...
  drawSkyMonkey(ctx, frames){
    ...
    ctx.drawImage(skyMonkey, skyMonkeyPos.startX, skyMonkeyPos.startY,
      skyMonkeyPos.width, skyMonkeyPos.height, this.skyMonkeyPosX, 80, 150, 150);
  }
  ...
  moveMonkeys(){
    ...
    this.skyMonkeyPosX -= this.offset;
  }
